...
function GenerateGame(c, r) {
    ...
    //If ProximoLevel is equal to false it indicates that the game should stop
    if (!NextLevel)
        return;
        ...
        function () {
            ...
            $(".container").animate({
                ...
                function () {
                    ...
                    // I create randomly which circles on the //board can be clicked and which ones //can't be clicked
                    CreateGreenFigure();
                }
            )
        }
